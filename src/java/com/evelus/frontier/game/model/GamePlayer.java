 ...
 */
public final class GamePlayer extends GameMob implements Player {
    ...
    @Override
    public void displayTabAndWindow(int tabParentId, int windowId) {
        widgetHandler.setTabAndWindow(tabParentId, windowId);
    }

    @Override
    public void displayChatboxInterface(int parentId) {
        widgetHandler.displayChatboxInterface(parentId);
    }
